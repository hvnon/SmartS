...
public class CartFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        ProductTouchAdapter adapter = new ProductTouchAdapter(getActivity(), mListProductInCart);
    ...
    private void initializeData(){
        ...
        mListProductInCart.add(new ProductCartTouchModel("Fashionable Men's Athletic Shoes With Color Matching and Letter", "$14.4", "$12.3", R.drawable.example, lstColorSizes, Constants.PRODUCT_STATUS_SENT));
        mListProductInCart.add(new ProductCartTouchModel("Fashionable Men's Athletic Shoes With Color Matching and Letter", "$12.4", "$21.2", R.drawable.example1, lstColorSizes, Constants.PRODUCT_STATUS_SENT));
        mListProductInCart.add(new ProductCartTouchModel("Fashionable Men's Athletic Shoes With Color Matching and Letter", "$12.5", "$23.1", R.drawable.example, lstColorSizes, Constants.PRODUCT_STATUS_NOT_FOUND));
    }
}
